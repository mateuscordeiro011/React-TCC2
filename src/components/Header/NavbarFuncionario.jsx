// src/components/Header/NavbarFuncionario.jsx
...
export default function NavbarFuncionario() {
  ...
  return (
    ...
    >
      {/* LOGO - Link para Home ou Painel do Funcionário */}
      <Link to="/home-funcionario" className="logo">
        <img src={darkMode ? logoLight : logoDark} alt="Logo" id="header-logo" />
      </Link>

      {/* MENU DE NAVEGAÇÃO INTERNA DO FUNCIONÁRIO */}
      <ul className="menu">
        <li><Link to="/formproduto" onClick={() => setDropdownOpen(false)}>Produtos</Link></li>
        <li><Link to="/formanimal" onClick={() => setDropdownOpen(false)}>Animais</Link></li>
        <li><Link to="/formdoacao-funcionario" onClick={() => setDropdownOpen(false)}>Doações (Ver)</Link></li>
        <li><Link to="/relatorios" onClick={() => setDropdownOpen(false)}>Relatórios</Link></li>
      </ul>
      ...
      <div className="user-icon" onClick={toggleDropdown}>
        ...
        {dropdownOpen && (
          <ul className="dropdown-menu">
            {/* Exemplo: Links para páginas internas específicas do funcionário */}
            <li>
